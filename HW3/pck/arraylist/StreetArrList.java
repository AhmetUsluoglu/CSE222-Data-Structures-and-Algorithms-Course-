...
public class StreetArrList {
    ...
    private ArrayList<Building> side1 = new ArrayList<Building>();
    private ArrayList<Building> side2 = new ArrayList<Building>();
    ...
    // Creating a new arraylist of street names.
    public StreetArrList(){}

    // Creating a new street array list with a street length of 5.
    public StreetArrList(int streetLength){length = streetLength +1;}
    ...
    public Building get_building(int index, boolean side) {
        if (side)
        {if(index < side1Length && index >= 0) return side1.get(index);}
        else
        { if(index < side2Length && index >= 0) return side2.get(index);}
        return null;
    }
    ...
    public boolean checkSlot(Building newBuilding, boolean flag) {
        if (flag)
        {
            ...
            {
                if (side1.get(i).get_pos() + side1.get(i).get_len() >= newBuilding.get_pos() && side1.get(i).get_pos() + side1.get(i).get_len() <= newBuilding.get_pos() + newBuilding.get_len()) return false;
                if (newBuilding.get_pos() + newBuilding.get_len() >= side1.get(i).get_pos() && newBuilding.get_pos() + newBuilding.get_len() <= side1.get(i).get_pos()+ side1.get(i).get_len()) return false;
        ...
        else
        {
            ...
            {
                if (side2.get(i).get_pos() + side2.get(i).get_len() >= newBuilding.get_pos() && side2.get(i).get_pos() + side2.get(i).get_len() <= newBuilding.get_pos() + newBuilding.get_len()) return false;
                if (newBuilding.get_pos() + newBuilding.get_len() >= side2.get(i).get_pos() && newBuilding.get_pos() + newBuilding.get_len() <= side2.get(i).get_pos()+ side2.get(i).get_len()) return false;
                if (newBuilding.get_pos() + newBuilding.get_len() > length) return false;
                if (newBuilding.get_pos() < 0 || newBuilding.get_len() < 0) return false;
            }
        }
    ...
    public void MaxHeight() {
        for (int i = 0; i < side1Length; i++)
        {
           if( side1.get(i).get_height() >= height) height =  side1.get(i).get_height();
        }
        for (int i = 0; i < side2Length; i++)
        {
            if( side2.get(i).get_height() >= height) height =  side2.get(i).get_height();
        }
        height += 2;
    }
    ...
    public void FillSiluet() {
        ...
        for(int i = 0; i < side1Length; i++)
        {
            start =  side1.get(i).get_pos();
            end = side1.get(i).get_pos() + side1.get(i).get_len();
            currHeight = side1.get(i).get_height();
        ...
        for(int i = 0; i < side2Length; i++)
        {
            start =  side2.get(i).get_pos();
            end = side2.get(i).get_pos() + side2.get(i).get_len();
            currHeight = side2.get(i).get_height();
            for(int x = start; x <= end; x++)
            {
    ...
    public void listOfBuildings(int call){
        ...
        for (int i = 0; i < side1Length; i++,count++)
            System.out.println(count +". Building (Side 1) =  "+side1.get(i));
        for (int i = 0; i < side2Length; i++,count++)
            System.out.println(count +". Building (Side 2)=  "+side2.get(i));
        ...
        while(next == false) {
            ...
            if (choice == 1){
                ...
                for (int i = 0; i < side1Length; i++,num++)
                    if(num == chosen) System.out.println(num +". Building =  "+side1.get(i));
                for (int i = 0; i < side2Length; i++,num++)
                    if(num == chosen) System.out.println(num +". Building =  "+side2.get(i));
    ...
    public void PlaygroundRatio(){
        ...
        for (int i = 0; i < side1Length; i++)
        {
            if (side1.get(i) instanceof Playground)
            {
                count++;
                totalLen += side1.get(i).get_len();
            }
        }
        for (int i = 0; i < side2Length; i++)
        {
            if (side2.get(i) instanceof Playground)
            {
                count++;
                totalLen += side2.get(i).get_len();
            }
        }
    ...
    public int TotalUsedSpace(){
        int total = 0;
        for (int i = 0; i < side1Length; i++) total += side1.get(i).get_len();
        for (int i = 0; i < side2Length; i++) total += side2.get(i).get_len();
        return total;
    }
