...
public class StreetLDLinkedList {
    ...
    private LDLinkedList<Building> side1 = new LDLinkedList<Building>();
    private LDLinkedList<Building> side2 = new LDLinkedList<Building>();
    ...
    // Creating a new instance of the StreetLDLinkedList class.
    public StreetLDLinkedList(){}

    // Creating a linked list with a length of the street.
    public StreetLDLinkedList(int streetLength){length = streetLength +1;}
