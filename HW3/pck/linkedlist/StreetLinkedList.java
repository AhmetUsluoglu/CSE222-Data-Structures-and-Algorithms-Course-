...
public class StreetLinkedList {
    ...
    private LinkedList<Building> side1 = new LinkedList<Building>();
    private LinkedList<Building> side2 = new LinkedList<Building>();
    ...
    // Creating a new instance of the StreetLinkedList class.
    public StreetLinkedList(){}

    // Creating a linked list with a street length of 5.
    public StreetLinkedList(int streetLength){length = streetLength +1;}
